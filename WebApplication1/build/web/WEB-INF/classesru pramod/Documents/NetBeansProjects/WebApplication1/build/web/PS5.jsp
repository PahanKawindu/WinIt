...
<html lang="en">
    ...
    <body>
        ...
        <h1 style="font-size: 27px;">PlayStaion 5</h1>
                ...
                <div class="container">
                    <div class="card">
                        <div class="left-section">
                            <img src="images/img1.jpg" alt="Asus Rog Strix Laptop">
                        </div>
                        <div class="right-section">
                            ...
                            <p class="time-remaining">Time remaining: <strong><span style="color: orange;">05:17:03:04</span></strong></p>

                            <button class="bid-button">Bid LKR 212,000</button>

                        </div>
                    </div>
                    <div class="details">
                        <h2>Item Description</h2>
                        <p>Used PlayStation 5 in a mint condition with the controller. Up for the highest Bid!</p>
